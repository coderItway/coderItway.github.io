...
export const sidebar: DefaultTheme.Config['sidebar'] = {
  ...
  '/courses/html/': getItems("courses/html"),
  '/courses/css/': getItems("courses/css"),
  '/courses/javascript/': getItems("courses/javascript"),
  '/courses/dom&bom/': getItems("courses/dom&bom"),
  '/courses/vue/': getItems("courses/vue"),
  '/courses/h5/': getItems("courses/h5"),
  '/courses/AnimateIamge/': getItems("courses/AnimateIamge"),
  '/courses/general/': getItems("courses/general"),

  '/codeshow/animate/': getItems("codeshow/animate"),
}
